	...
	<div class="modal-dialog">
		...
		<div class="modal-content bborder_bottom">
			...
			<div class="modal-body review_modal_body1 NopaddB">
				<form class="modal_form_rreview" id="submit_package_for_payment"  method="post" enctype="multipart/form-data" action="credit-package-buy">
				{{csrf_field()}}
				<input type="hidden" name="credit_package_id" id="credit_package_id" value="">
				<div class="col-md-4 col-sm-6 co-xs-12">
					...
					<div class="col-md-4 col-sm-6 co-xs-12">
							<div class="your-mail">
								<input value="Submit" class="btn btn-default" id="confirm-purchase" type="submit">
							</div>
					</div>
				</form>
			</div>
