														...
														@if(!$user->isEmpty())
															@foreach($user as $row)
																<tr>
																	...
																	<td>@if($row->is_email_verified == 0 && $row->user_status == 0){{'Email Not Verified'}}
																	...
																	<a href="admin-customer-details/{{$row->user_id}}" title="View"> <i class="fa fa-eye delet" aria-hidden="true"></i></a>
																		...
																		<a href="admin-customer-approve/{{$row->user_id}}" onclick="return confirm('Are you sure to approve this customer ?')" title="Click to approve"> <i class="fa fa-check-circle cncl1" aria-hidden="true"></i></a>
