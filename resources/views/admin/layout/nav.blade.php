		...
		<div id="sidebar-menu">
			<ul>
				...
				<li class="has_sub">
					...
					<ul class="list-unstyled">
						<li><a href="admin-static-page-list" class="<?php if(Request::segment(1) == "admin-static-page-list" || Request::segment(1) == "admin-edit-static-page"){?>active1<?php } ?>">Static Page</a></li>
					</ul>
				</li>
			</ul>
