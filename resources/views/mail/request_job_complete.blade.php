	...
	<body>
		<div style="width:100%; margin:0 auto;">
			...
			<div style="width:100%; border:1px solid #dddddd; margin: 5px 0; padding:10px; width:98%;">
				...
				<h1 style="font-family:\'Open Sans\', sans-serif; font-size:19px; font-weight:500; color:#0455ca; padding:0 10px; margin:5px 0 6px 0;"> Dear ,{{$request_complete->customer_name}}</h1>
				...
				<div style="display:block;overflow:hidden; margin: 15px 0px 15px 0px;">
					<div style="font-family:\'Open Sans\', sans-serif; font-size:18px; font-weight:500; color:#424242; padding:8px 8px;
                        ...
                        <p style="margin:0 0 8px 0; float:left;"><p>{{$request_complete->tradesman_name}} has been marked as completed for the job of {{$request_complete->job_title}}.</p>
                    </div>
						<p style="margin:0; line-height:22px; text-align:left;">
						{{$request_complete->feedback_description}}
						</p>
					</div>
				</div>
