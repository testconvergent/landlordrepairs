    ...
    <div style="width:600px; margin:0 auto; background:#f2f2f2; overflow:hidden; padding:0 0 40px 0;">
        ...
        <div style="width:520px; margin:0 auto; background:#FFF; overflow:hidden;">
            ...
            <div style="overflow:hidden; margin-bottom: 5px; padding: 25px;">
                ...
                <h2 style="font-family: 'Open Sans', sans-serif; font-size:21px; font-weight:700; color:#333; margin: 0 0 22px 0;">Hi, {{$invitation->tradesman_name}}</h2>
                ...
                <div style="display:block; overflow:hidden; width:100%; margin:20px 0 20px 0;">
					<div style="font-family: 'Open Sans', sans-serif; float:left; font-size:15px; font-weight:400; color:#333; display:block; overflow:hidden; width:100%;">
                        <p style="margin:0 0 8px 0; float:left;"><p> {{$invitation->customer_name}} has been sent a invitation for the {{$invitation->looking_for}}.</p>
                    </div>                   
                </div>
                ...
                <div style="display:block; overflow:hidden; width:100%; margin:20px 0 20px 0;">
                    <div style="font-family: 'Open Sans', sans-serif; float:left; font-size:15px; font-weight:400; color:#333; display:block; overflow:hidden; width:100%;">
                        <p style="margin:0 0 8px 0; float:left;"><strong>Job Budget :</strong> ${{$invitation->budget}}</p>
                    </div>

                    <div style="font-family: 'Open Sans', sans-serif; float:left; font-size:15px; font-weight:400; color:#333; display:block; overflow:hidden; width:100%;">
                        <p style="margin:0 0 8px 0; float:left;"><strong>Deadline :</strong> {{$invitation->deadline}}</p>
                    </div>
                </div>
