	...
	<div class="tradesmen_signup">
		<div class="container">
			...
			<div class="setup_frm ">
				...
				<form id="tradesmen_frm" action="tradesmen-signup" method="post" class="mak_frm">
				{{csrf_field()}}
					<div class="col-md-8 col-sm-8 co-xs-12">
						<div class="your-mail">
							<label>Phone verification Code</label>
							<input class="form-control required" placeholder="Enter Your mobile vcode" name="email" id="email" type="text">
						</div>
					</div>
					<div class="col-md-12">
						<div class="fnsh">
